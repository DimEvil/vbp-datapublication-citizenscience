...
subtitle: "VBP-INBO-waarnemingen-occurrences_202_paddestoelen_hoge resolutie
...
```{r eval=FALSE, include=FALSE}
input_interim <- dbReadTable(con, "INBO_WNMN_paddestoelen_native")  # werkt ook voor views
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data-paddenstoelen", "data", "processed", "occurrence_fungi_high_res.csv"), na = "")
```
