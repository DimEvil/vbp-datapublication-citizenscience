...
```{r}
occurrence %<>% mutate(dwc_datasetName = "INBO collaborator Occurrences of fungi recorded in waarnemingen.be in Flanders, Belgium") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data-paddenstoelen", "data", "processed", "occurrence_fungi.csv"), na = "")
```
