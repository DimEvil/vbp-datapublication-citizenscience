...
subtitle: "VBP-INBO-waarnemingen-occurrences_2025_invertebrates
...
con <- dbConnect(SQLite(), (here::here("observations-instituut-voor-natuur-en-bosonderzoek (9).sqlite" )))
```
...
```{r}
occurrence %<>% mutate(dwc_datasetName = "INBO collaborator Occurrences of invertebrates recorded in waarnemingen.be in Flanders, Belgium") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data-ongewervelden", "data", "processed", "occurrence_invertebrates.csv"), na = "")
```
