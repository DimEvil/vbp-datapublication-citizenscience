...
```{r}
input_interim <- read.csv(here::here("datasets", "np-datavragen-data", "data", "raw", "INBO_wnmn_vogels.csv" ))
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data", "data", "processed", "occurrence_vogels.csv"), na = "")
```
