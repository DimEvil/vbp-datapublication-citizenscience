...
```{r eval=FALSE, include=FALSE}
input_interim <- dbReadTable(con, "INBO_WNMN_mossen_wieren_native")  # werkt ook voor views
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data-mossen-korstmossen", "data", "processed", "occurrence_mosses_etc_high_res.csv"), na = "")
```
