...
WHERE o.id is not '312316574'
AND species_group =  'Vogels'
AND ROUND (substr(rtrim(rtrim(rtrim(rtrim(substr(o.point, INSTR(o.point, '[') + 2, 38), '}')), ']')), instr(rtrim(rtrim(rtrim(rtrim(substr(o.point, INSTR(o.point, '[') + 2, 38), '}')), ']')), ',' )+2, 50), 5 ) > 50.67
-- 
-- 
