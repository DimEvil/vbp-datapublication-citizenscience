...
subtitle: "VBP-INBO-waarnemingen-occurrences_202_planten_hoge resolutie
...
```{r eval=FALSE, include=FALSE}
input_interim <- dbReadTable(con, "INBO_WNMN_PLANTS_from2019")  # werkt ook voor views
```
...
```{r}
occurrence %<>% mutate(dwc_datasetName = "INBO collaborator Occurrences -High resolution - of plants recorded in waarnemingen.be in Flanders, Belgium") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
...
```{r}
write_csv(occurrence_joined, here::here("datasets", "np-datavragen-data-vaatplanten", "data", "processed", "occurrence_planten_high_res.csv"), na = "")
```
