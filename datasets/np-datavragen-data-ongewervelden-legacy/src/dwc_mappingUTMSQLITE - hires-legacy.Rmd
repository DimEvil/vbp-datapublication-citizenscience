...
subtitle: "VBP-INBO-waarnemingen-occurrences_202_ongewervelden_hoge resolutie_legacy
...
```{r eval=FALSE, include=FALSE}
input_interim <- dbReadTable(con, "INBO_WNMN_invertebrata_legacy")  # werkt ook voor views
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data-ongewervelden-legacy", "data", "processed", "occurrence_invertebrates_high_res_legacy.csv"), na = "")
```
