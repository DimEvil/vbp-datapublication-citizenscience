...
subtitle: "VBP-INBO-waarnemingen-occurrences_202_vogels
...
```{r}
input_interim <- read.csv(here::here("datasets", "np-datavragen-data-vogels", "data", "raw", "INBO_wnmn_vogels.csv" ))
```
...
```{r}
occurrence %<>% mutate(dwc_datasetName = "VBP - INBO collaborator Occurrences of Birds recorded in waarnemingen.be in  Flanders, Belgium") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
...
```{r}
write_csv(occurrence, here::here("datasets", "np-datavragen-data-vogels", "data", "processed", "occurrence_vogels.csv"), na = "")
```
